                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="bg-popover">
                              ...
                              <DropdownMenuItem onClick={() => navigate(`/payment-history/${encodeURIComponent(invoice.supplier)}`)}>Payment History</DropdownMenuItem>
                              <DropdownMenuItem onClick={() => navigate(`/send-reminder/${invoice.id}`)}>Send Reminder</DropdownMenuItem>
                              <DropdownMenuItem onClick={() => navigate(`/generate-statement/${encodeURIComponent(invoice.supplier)}`)}>Generate Statement</DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                        </TableCell>
                      </TableRow>
